...
// import { addDoctor, fetchDoctors } from "../services/api";
...
//   // Refactored function to load doctors for the given hospitalId.
//   const loadDoctors = async (hospId) => {
//     if (hospId) {
//       try {
//         const data = await fetchDoctors(hospId);
...
//   // Load doctors whenever hospitalId changes.
//   useEffect(() => {
...
//         speciality,
//       };
//       // We expect the backend to return a message indicating success.
//       const response = await addDoctor(hospitalId, doctorData);
//       if (response && response.message === "Doctor added successfully!") {
//         alert("Doctor added successfully");
//         setName("");
//         setSpeciality("");
//         // Re-load the doctors list so the new doctor appears immediately.
//         loadDoctors(hospitalId);
//       } else {
